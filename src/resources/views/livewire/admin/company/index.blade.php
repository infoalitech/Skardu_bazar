<div>
	...
	<div class="row">
		...
		<div class="col-sm-8 text-right pr-5">
			...
			<button class="btn btn-primary" wire:click="create()">Add Company</button>
		</div>
	</div>
...
<!-- Delete Model -->
	<x-jet-confirmation-modal wire:model="confirmingDeletion">
		...
		<x-slot name="content">
		    {{ __('Are you sure you want to delete the company? Once your account is deleted, all of its resources and data will be permanently deleted.') }}
		</x-slot>
		<x-slot name="footer">
